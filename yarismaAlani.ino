...
void robotLogic() {
  ...
  if(!engelyok){
    ...
    forwardTimed(300);
      ...
      if ((red - green > 90) && (red - blue > 95) && c > 520) {
      ...
      else if ((blue-green>-2)&&(blue-red>-9)&&(blue-red<20) && c > 400) {
      ...
      } else if ((green - blue > 25) && (green - red > 10) && c > 420) {
        color = "Green";
...
else if ((green - blue > 25) && (green - red > 10) && c < 400 && yesilkapaksayisi>0) {
        zemin = "Green";
        Stop();
...
//DRIVETRAIN
void forward() {
  dxlCom.setMovingSpeed(rightMotorsIndex[0], 1973);
  dxlCom.setMovingSpeed(rightMotorsIndex[1], 1973);
  dxlCom.setMovingSpeed(leftMotorsIndex[0], 950);
  dxlCom.setMovingSpeed(leftMotorsIndex[1], 950);
